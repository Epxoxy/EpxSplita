...
namespace EpxSplita.ControlsExtension
{
    public class PasswordBoxMonitor : DependencyObject
    {
        ...
        public static readonly DependencyProperty KeywordProperty =
            DependencyProperty.RegisterAttached("Keyword", typeof(string), typeof(PasswordBoxMonitor), new PropertyMetadata(""));
        ...
        private static void OnLoadSavedChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if ((bool)e.NewValue)
            {
                ...
                string decryptData = "";
                string keyword = GetKeyword(pb);
                UserSerives.StoreUserData.decryptUserData(loadKey, ref decryptData, keyword);
